...
function WelcomeDashboard({ onPlay }) {
  return (
    <main className="min-h-screen bg-[#1E3A8A] bg-stripes px-4 py-8 md:py-12 flex items-center justify-center">
      <section className="w-full max-w-5xl bg-white border-4 border-black shadow-pop-xl rounded-[2rem] overflow-hidden">
        <div className="grid lg:grid-cols-[1.2fr_0.8fr]">
          <div className="p-7 md:p-12 bg-tycoon-orange text-black relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h1 className="mt-7 max-w-xl font-display font-black text-5xl md:text-7xl leading-[0.9] tracking-tight">
                TYCOON<br /><span className="text-white">PLATE TYPER</span>
              </h1>
              <p className="mt-6 max-w-lg text-lg md:text-xl font-bold leading-relaxed text-black/80">
              ...
              <button
                type="button"
                onClick={onPlay}
                className="mt-8 bg-white hover:bg-orange-100 text-black font-display font-black text-2xl px-8 py-4 rounded-2xl border-4 border-black shadow-pop-lg pop-btn inline-flex items-center gap-3"
              >
          ...
          <div className="p-7 md:p-10 bg-orange-50 flex flex-col justify-center">
            ...
            <div className="mt-8 space-y-4">
              {[
                ...
                <div key={title} className="flex gap-3 items-start">
                  <Icon className="w-6 h-6 mt-0.5 shrink-0 text-orange-600" />
