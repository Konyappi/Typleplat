...
function WelcomeDashboard({ onPlay }) {
  return (
    <main className="min-h-screen bg-tycoon-purple bg-stripes px-4 py-8 md:py-12 flex items-center justify-center">
      <section className="w-full max-w-5xl bg-white border-4 border-black shadow-pop-xl rounded-[2rem] overflow-hidden">
        <div className="grid lg:grid-cols-[1.2fr_0.8fr]">
          <div className="p-7 md:p-12 bg-tycoon-purpleDark text-white relative overflow-hidden">
            <div className="absolute -right-10 -top-10 text-[10rem] opacity-15 rotate-12 select-none">🚗</div>
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 bg-tycoon-yellow text-black border-3 border-black rounded-full px-3 py-1 text-xs font-black shadow-pop-sm">
              ...
              <h1 className="mt-7 max-w-xl font-display font-black text-5xl md:text-7xl leading-[0.9] tracking-tight">
                TYCOON<br /><span className="text-tycoon-yellow">PLATE TYPER</span>
              </h1>
              ...
              <button
                type="button"
                onClick={onPlay}
                className="mt-8 bg-tycoon-yellow hover:bg-yellow-300 text-black font-display font-black text-2xl px-8 py-4 rounded-2xl border-4 border-black shadow-pop-lg pop-btn inline-flex items-center gap-3"
              >
          ...
          <div className="p-7 md:p-10 bg-purple-50 flex flex-col justify-center">
